...
\begin{FBTDemo}[numbers=left]{
\centering
\adjustimage{scale=.6, trim=0 520 0 0, clip}{letter-std.pdf}
}
...
\begin{Demo}
\centering
\adjustimage{scale=.6, trim=0 400 0 0, clip}{letter-bus.pdf}
\end{Demo}
\caption{商业信函}
...
\begin{Demo}
\centering
\adjustimage{scale=.6, trim=0 580 0 0, clip}{letter-memo.pdf}
\end{Demo}
\caption{标准备忘录}
...
\begin{Demo}
\centering
\adjustimage{scale=.6, trim=0 520 0 0, clip}{letter-pr.pdf}
\end{Demo}
\caption{新闻发布稿}
\label{exa:letter_pr}
\end{example}
